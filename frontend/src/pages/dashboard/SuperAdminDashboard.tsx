  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        {[
          { label: 'Active', count: activeOrgs, color: 'text-emerald-600 bg-emerald-50 border-emerald-100' },
      ...
      <div className="card overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <div>
            <h2 className="font-bold text-gray-900">Organizations</h2>
            <p className="text-xs text-gray-400 mt-0.5">{orgs.length} total registered</p>
          </div>
          <Link to="/admin/organizations" className="text-sm font-semibold text-emerald-600 hover:text-emerald-700 transition-colors">
            View all →
          </Link>
        </div>

        {orgsLoading ? (
          <div className="px-6 py-12 flex items-center justify-center gap-3 text-gray-400">
          ...
          <div className="px-6 py-16 text-center">
            ...
            <p className="text-sm font-semibold text-gray-900 mb-1">No organizations yet</p>
            <p className="text-xs text-gray-400 mb-4">Add your first school to get started</p>
            <Link to="/admin/organizations/new" className="btn-primary text-xs px-4 py-2">
              Add Organization
            </Link>
          </div>
        ) : (
            ...
            {orgs.slice(0, 10).map((org) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-400 truncate">{org.slug}.edustack.pk</p>
                </div>

                {/* Students */}
                <div className="hidden sm:flex items-center gap-1.5 text-sm text-gray-500 shrink-0">
                ...
                <Link
                  ...
                  className="hidden group-hover:flex items-center gap-1 text-xs font-semibold text-emerald-600 hover:text-emerald-700 transition-colors shrink-0"
                >
                  Manage
